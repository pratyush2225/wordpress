...
if (themify_get('header_wrap') === 'slider') {
	...
	<div id="gallery-controller" class="tf_w tf_h tf_abs tf_overflow">
		<div <?php echo themify_get_element_attributes($slider_args) ?> class="swiper-container tf_carousel tf_overflow tf_h tf_w tf_clearfix" data-height="100%">
			...
			<?php foreach ($images as $image): ?>
			    ...
			    ?>
	    		<div class="swiper-slide tf_lazy"><?php echo themify_get_image( array( 'w' => '', 'h' => '', 'image_size'=>$image_size,  'src' => $image_data[0], 'alt'=> $alt,'is_slider'=>true,'lazy_load'=>$isFirst,'class'=>'tf_w tf_h' ) );?></div>
				<?php $isFirst=true;?>
			<?php endforeach; ?>		
		    </div>
		</div>
