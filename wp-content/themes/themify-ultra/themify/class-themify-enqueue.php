...
class Themify_Enqueue_Assets {
    ...
    public static function wp_footer() {
		...
		if(isset(self::$css['in_footer'])){
			...
			?>
				<link rel="preload" href="<?php echo $v['s']?>?ver=<?php echo $v['v']?>" as="style"<?php echo $m?>><link id="<?php echo  $k?>-css" rel="stylesheet" href="<?php echo $v['s']?>?ver=<?php echo $v['v']?>"<?php echo $m?>>
			<?php 
			}
	...
	*/
	...
	private static function getCurrentVersionFolder($blog_id=false){
			global $wp_version;
			$object=wp_get_theme();
