...
tb_app.Constructor[b];delete tb_app.Constructor}z=ThemifyBuilderCommon;l=tb_app}this.breakpointsReverse=Object.keys(themifyBuilder.breakpoints).reverse();this.breakpointsReverse.push("desktop");const c=this;b=c.get();const d=function(b){z.Lightbox.setup();c.data=b;a&&a()};!1!==b?d(b):function(a){++a;p.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_load_form_templates",tb_load_nonce:themifyBuilder.tb_load_nonce,page:a},success(a){a&&(d(a),c.set(a))}})}(0);c.static=themifyBuilder.i18n.options;
...
e=f.not_empty:void 0!==f.select&&c!==f.select.value?e=f.select:void 0!==f.checked&&!0===a.checked?e=f.checked:void 0!==f.not_checked&&!1===a.checked&&(e=f.not_checked):e=f.empty;if(e){if(void 0===d||null===d||0===d.length)d=a.closest(".tb_tab"),null===d&&(d=a.closest(".tb_expanded_opttions"),null===d&&(d=w.document.getElementById("tb_lightbox_container")));f=void 0!==e.hide;b=void 0!==e.show;const u=this;a=[];const h=function(a,b){let c;const d=Object.keys(a);for(let e=0,f=d.length;e<f;++e){if(void 0!==
a[d[e]].id&&a[d[e]].id===b){c=a[d[e]];break}if(a[d[e]]&&"object"===typeof a[d[e]]&&(c=h(a[d[e]],b),void 0!==c))break}return c};c=function(a,b,c){const d=a.dataset.type;let e;"radio"===d?(e=a.querySelector("input:checked"),null===e&&(e=a.getElementsByTagName("input")[0])):"checkbox"===d||"toggle_switch"===d?e=a.getElementsByTagName("input")[0]:"select"===d&&(e=a.getElementsByTagName("select")[0]);void 0!==e&&u.binding(e,b,e.value,c)};!0!==b||Array.isArray(e.show)||(e.show=[e.show]);!0!==f||Array.isArray(e.hide)||
(e.hide=[e.hide]);let n=!0===b?e.show:[];!0===f&&(n=n.concat(e.hide));for(let c=0,u=n.length;c<u;++c){if(!0===f&&void 0!==e.hide[c]){var g=d.querySelectorAll("."+e.hide[c]);for(var k=g.length-1;-1<k;--k)if(g[k].classList.add("_tb_hide_binding"),"object"===typeof this.data&&null!==this.type&&"object"===typeof this.data[this.type]){var m=h(this.data[this.type][this.clicked],n[c]);"object"===typeof m&&"object"===typeof m.binding&&a.push({el:g[k],data:m})}}if(!0===b&&void 0!==e.show[c])for(g=d.querySelectorAll("."+
...
var d=!1,e=!1;let f=l.activeModel,g;null!==f?(this.component=f.get("elType"),e=h.getElementsByClassName("tb_element_cid_"+f.cid)[0],"module"===this.component?(this.is_ajax="ajax"===themifyBuilder.modules[a].type,d="mod_settings",void 0!==f.get("is_new")&&(this.is_new=!0,e=e.closest(".module_row"))):d="styling",this.values=p.extend(!0,{},f.get(d)),void 0!==e&&(l.beforeEvent=z.clone(e)),e=void 0!==f.get("visibileClicked"),d=!1===e&&("column"===this.component||"subrow"===this.component||void 0!==f.get("styleClicked")),
void 0===this.data[a].visibility&&(this.data[a].visibility=!0),void 0===this.data[a].animation&&(this.data[a].animation=!0),c=this.data[a]):(this.values={},this.component=null,c=a);var k=h.createDocumentFragment();a=h.createDocumentFragment();const m=this;var u={styling:"ti-brush",animation:"ti-layers-alt",visibility:"ti-eye"};const q=function(a,b){const c=h.createElement("div"),d=h.createDocumentFragment();c.className="tb_options_tab_content";if("visibility"===a||"animation"===a)b=m.static[a];else if("styling"===
a){const a=h.createElement("div"),b=l.GS.globalStylesHTML();a.className="tb_styling_tab_header";a.appendChild(m.getSwitcher());b&&a.appendChild(b);d.appendChild(a)}c.appendChild(m.create(b));d.appendChild(c);"styling"===a&&(a=h.createElement("a"),b=h.createElement("i"),a.href="#",a.className="reset-styling",b.className="tf_close",a.appendChild(b),a.appendChild(h.createTextNode(m.label.reset_style)),a.addEventListener("click",m.resetStyling.bind(m)),d.appendChild(a),"visual"===l.mode&&f&&setTimeout(function(){l.liveStylingInstance.module_rules=
m.styles},600));b=null;return d};this.clicked=null;for(var n in c){if(!1===c[n])continue;let b=h.createElement("li"),f=h.createElement("a"),g=h.createElement("span"),v=h.createElement("div"),A=void 0!==c[n].name?c[n].name:this.label[n],D="tb_options_"+n;f.href="#"+D;f.textContent=A;"setting"!==n&&(f.className="tb_tooltip",g.textContent=A,u[n]&&f.appendChild(l.Utils.getIcon(u[n])),f.appendChild(g));v.id=D;v.className="tb_tab tb_options_tab_wrapper";if(!0===d&&"styling"===n||!0===e&&"visibility"===
n||!1===d&&!1===e&&"setting"===n||null===this.component)b.className="current",m.clicked=n,void 0!==c[n].html?v.appendChild(c[n].html):v.appendChild(q(n,c[n].options)),v.style.display="block",v.dataset.done=!0;v.addEventListener("themify_builder_tabsactive",function(a){a=a.detail.id.replace("#tb_options_","");m.clicked=a;void 0===this.dataset.done&&(this.dataset.done=!0,this.appendChild(q(a,c[a].options)),m.callbacks(),"setting"===a&&m.setUpEditors())},{passive:!0});f.addEventListener("click",this.switchTabs);
a.appendChild(v);b.appendChild(f);k.appendChild(b)}n=z.Lightbox.$lightbox[0].getElementsByClassName("tb_options_tab")[0];for(u=z.Lightbox.$lightbox[0].getElementsByClassName("tb_lightbox_actions_wrap")[0];null!==n.firstChild;)n.removeChild(n.firstChild);for(;null!==u.firstChild;)u.removeChild(u.firstChild);n.appendChild(k);if(void 0!==b||f){const a=h.createElement("button");a.className="builder_button builder_save_button";a.title=void 0!==b&&void 0!==b.ctr_save?this.label[b.ctr_save]:this.label.ctr_save;
...
a.touches?a.touches[0].clientX:a.clientX,c=a.touches?a.touches[0].clientY:a.clientY;b="mousemove"===a.type?a.target:y.elementFromPoint(b,c);var d=c-n-B.getBoundingClientRect().top;if(0<d&&d<w){if(l.style.transform="translateY("+d+"px)",E(c),!(c>=p||c<=A)){if(b&&b!==v&&b.classList.contains("tb_toggleable_item")){d=c>h?"bottom":"top";if(k!==d||g!==b)v.style.display="none","bottom"===d?b.after(v):b.before(v),v.style.display="";g=b;k=d}h=c}}else E(c)}})},E=function(a){if(t)if(a>=p||a<=A){if(!1===C){C=
!0;const b=parseInt(p/10);t.scrollTop+=a<=A?-1*b:b;f&&clearTimeout(f);f=setTimeout(function(){requestAnimationFrame(function(){C&&(C=!1,E(a))})},2*b)}}else f&&clearTimeout(f),C=!1},F=function(a){y.body.classList.add("tb_start_animate","tb_move_drag");B=v.parentNode;B.classList.add("tb_sort_start");if(void 0!==tinyMCE){var b=B.getElementsByClassName("tb_lb_wp_editor");for(let a=b.length-1;-1<a;--a){let c=b[a].id;r[c]=tinymce.get(c).getContent();tinyMCE.execCommand("mceRemoveEditor",!1,c)}}v.classList.contains("tb_closed")||
((b=v.getElementsByClassName("tb_toggleable_fields_options")[0])&&(b.style.display="none"),v.classList.add("tb_closed"),m=!0);l=v.cloneNode(!0);(b=l.getElementsByClassName("tb_toggleable_fields_options")[0])&&b.remove();t=v.closest(".tf_scrollbar");l.className+=" tb_sort_handler";v.classList.add("tb_current_sort");v.after(l);n=l.getBoundingClientRect().height/2;w=B.offsetHeight;b=t.getBoundingClientRect();A=b.top;p=b.bottom-40;z(a)};y.addEventListener(c.mouseup,function(a){this.removeEventListener(c.mousemove,
F,{passive:!0,once:!0});this.removeEventListener(c.mousemove,z,{passive:!0});if(B){a.stopImmediatePropagation();d&&cancelAnimationFrame(d);f&&clearTimeout(f);l&&l.remove();if(void 0!==tinyMCE)for(let a in r)tinyMCE.execCommand("mceAddEditor",!1,a),tinymce.get(a).setContent(r[a]);v.classList.remove("tb_current_sort");m&&((a=v.getElementsByClassName("tb_toggleable_fields_options")[0])&&(a.style.display=""),v.classList.remove("tb_closed"));requestAnimationFrame(function(){b.control.preview(B,null,{repeat:!0});
x.triggerEvent(B,"sortable");B.classList.remove("tb_sort_start");B=null})}this.body.classList.remove("tb_start_animate","tb_move_drag");g=l=m=k=h=r=t=y=w=C=n=A=p=v=d=f=null},{passive:!0,once:!0});y.addEventListener(c.mousemove,F,{passive:!0,once:!0});y.addEventListener(c.mousemove,z,{passive:!0})}},{passive:!0})},expand(a,b,c){a.addEventListener("click",function(a){if(this.classList.contains("tb_toggleable_field_disabled")||a.target.closest(".switch-wrapper"))a.target.closest(".tb_toggleable_fields_options")||
(a=this.getElementsByClassName("tb_toggleable_fields_options")[0],p(a).slideUp(function(){this.parentNode.classList.add("tb_closed")}));else{let d=this.getElementsByClassName("tb_toggleable_fields_options")[0];if(!d){d=h.createElement("div");d.style.display="none";d.className="tb_toggleable_fields_options tf_box tf_clear";this.appendChild(d);c.is_repeat=!0;let a=this.closest(".tb_toggleable_fields").id,e=null,k=this.getAttribute("data-id");void 0!==c.values[a]&&void 0!==c.values[a][k]&&void 0!==c.values[a][k].val&&
...
d.remove("tb_toggleable_field_disabled"):d.add("tb_toggleable_field_disabled","tb_closed");b.control.preview(c.parentNode,null,{repeat:!0})},render(a,b){const c=this,d=h.createElement("ul");d.className="tb_toggleable_fields tf_rel";!0===b.is_repeat?(d.dataset.inputId=a.id,d.className+=" tb_lb_option_child"):(d.id=a.id,d.className+=" tb_lb_option");const e=b.is_repeat,f=b.values[a.id];b.is_repeat=!0;const g=function(e,f){const g={type:"toggle_switch",id:"",options:{on:{name:"1",value:b.label.s},off:{name:"0",
value:b.label.hi}},"default":"1"===f.on?"on":"off",control:!1},k=h.createElement("li"),m=h.createElement("input"),t=h.createElement("div"),l=b.create([g]);t.innerHTML+=a.options[e].label;t.className="tb_toggleable_fields_title tf_plus_icon";m.type="hidden";m.value="";k.className="tb_toggleable_item tb_closed";"off"===g["default"]&&(k.className+=" tb_toggleable_field_disabled");k.setAttribute("data-id",e);void 0!==f.val&&(m.value=JSON.stringify(f.val));l.querySelector(".toggle_switch").addEventListener("change",
function(a){a.stopPropagation();c.disable(this,b)},{passive:!0});k.appendChild(m);k.appendChild(t);k.appendChild(l);c.expand(k,a.options[e],b);d.appendChild(k)};if(void 0!==f)for(let b in f)void 0!==a.options[b]&&g(b,f[b]);for(let b in a.options)void 0===f[b]&&g(b,a.options[b]);c.sort(d,b);b.is_repeat=e;return d}},sortable_fields:{getDefaults(a,b){const c=[{id:"icon",type:"icon",label:b.label.icon},{id:"before",type:"text",label:b.label.b_t},{id:"after",type:"text",label:b.label.a_t}];b={date:[{id:"format",
type:"select",label:b.label.d_f,"default":"def",options:{"F j, Y":b.label.F_j_Y,"Y-m-d":b.label.Y_m_d,"m/d/Y":b.label.m_d_Y,"d/m/Y":b.label.d_m_Y,def:b.label.def,custom:b.label.cus},binding:{not_empty:{hide:"custom"},custom:{show:"custom"}}},{id:"custom",type:"text",control:{event:"change"},label:b.label.cus_f,help:b.label.cus_fd_h}],time:[{id:"format",type:"select",label:b.label.t_f,"default":"def",options:{"g:i a":b.label.g_i_a,"g:i A":b.label.g_i_A,"H:i":b.label.H_i,def:b.label.def,custom:b.label.cus},
binding:{not_empty:{hide:"custom"},custom:{show:"custom"}}},{id:"custom",type:"text",control:{event:"change"},label:b.label.cus_f,help:b.label.cus_ft_h}],author:[{id:"l",type:"toggle_switch",label:b.label.l,options:"simple"},{id:"a_p",type:"toggle_switch",label:b.label.a_p,binding:{checked:{show:"p_s"},not_checked:{hide:"p_s"}},options:"simple"},{id:"p_s",type:"range",label:b.label.p_s,"class":"xsmall",units:{px:{max:96}},control:{event:"change"}}],comments:[{id:"l",type:"toggle_switch",label:b.label.l,
options:"simple"},{id:"no",type:"text",control:{event:"change"},label:b.label.no_c},{id:"one",type:"text",control:{event:"change"},label:b.label.one_c},{id:"comments",type:"text",control:{event:"change"},label:b.label.comments}],terms:[{id:"post_type",type:"query_posts",tax_id:"taxonomy"},{id:"l",type:"toggle_switch",label:b.label.l,options:"simple"},{id:"sep",type:"text",control:{event:"change"},label:b.label.sep}]};if(void 0!==b[a])for(let d=0,e=c.length;d<e;++d)b[a].push(c[d]);return b[a]},create(a,
b,c,d,e,f){const g=h.createElement("li");g.textContent=b.options[c].label;g.setAttribute("data-type",c);g.className="tb_sort_fields_item";if(!0===f){f=!1;if(d)void 0!==e&&(f=this.find(e,d));else{void 0!==e&&(f=this.find(e,c,!0));g.setAttribute("data-new",!0);b=z.Lightbox.$lightbox[0].getElementsByClassName(b.id)[0];let a=1;d=c+"_"+a;if(void 0!==b)for(;null!==b.querySelector('[data-id="'+d+'"]');)++a,d=c+"_"+a}g.setAttribute("data-id",d);c=h.createElement("span");d=h.createElement("input");!1!==f&&
void 0!==e[f].val&&(d.value=JSON.stringify(e[f].val));d.type="hidden";c.className="tb_sort_fields_remove tf_close";c.title=a.label["delete"];g.appendChild(l.Utils.getIcon("ti-pencil"));g.appendChild(d);g.appendChild(c)}return g},sort(a,b){const c=l.Utils.getMouseEvents();a.addEventListener(c.mousedown,function(a){if(("touchstart"===a.type||1===a.which)&&a.target.parentNode===this){let d,f,g,k=0,m=0,h,l,n,t={},r=this.ownerDocument,y=a.target,v,A;const p=function(a){a.stopImmediatePropagation();d&&
...
c===h.activeElement||(b.value=c);a&&0>=parseFloat(p(this).minicolors("opacity"))&&p(this).minicolors("opacity",0);"visual"===l.mode&&x.triggerEvent(this,"themify_builder_color_picker_change",{id:f,val:a?p(this).minicolors("rgbaString"):""})}}).minicolors("show");c=function(b){let c=parseFloat(this.value.trim().replace(",","."));if(1<c||isNaN(c)||""===c||0>c)c=a.value?1:"";"blur"===b.type&&(this.value=c);d.is_typing="keyup"===b.type;e.minicolors("opacity",c)};b.addEventListener("blur",c,{passive:!0});
b.addEventListener("keyup",c,{passive:!0});a.parentNode.appendChild(g);a.setAttribute("data-minicolors-initialized",!0)},setColor(a,b,c,d){let e=d,f="";""!==d&&(-1!==d.indexOf("_")?(l.Utils.toRGBA(d),d=d.split("_"),(f=d[1])?0>=parseFloat(f)&&(f=0):f=1,e=d[0]):(e=d,f=1),-1===e.indexOf("#")&&(e="#"+e));a.value=e;a.setAttribute("data-opacity",f);b.style.background=e;b.style.opacity=f;c.value=f},update(a,b,c){a=w.document.getElementById(a);null!==a&&(c=a.parentNode,void 0===b&&(b=""),this.setColor(a,
c.getElementsByClassName("minicolors-swatch-color")[0],c.nextElementSibling,b))},render(a,b){const c=h.createDocumentFragment(),d=h.createElement("div"),e=h.createElement("div"),f=h.createElement("input"),g=h.createElement("input"),k=h.createElement("span"),m=h.createElement("span"),u=b.getStyleVal(a.id),l=this;d.className="minicolors_wrapper";e.className="minicolors minicolors-theme-default";f.type="text";f.className="minicolors-input";f.autocomplete="off";void 0!==a["class"]&&(f.className+=" "+
a.class);!0===b.is_repeat?(f.className+=!0===b.is_sort?" tb_lb_sort_child":" tb_lb_option_child",f.dataset.inputId=a.id):(f.id=a.id,f.className+=" tb_lb_option");k.className="minicolors-swatch";m.className="minicolors-swatch-color tf_abs";g.type="text";g.className="color_opacity";k.appendChild(m);e.appendChild(f);e.appendChild(k);d.appendChild(e);d.appendChild(g);b.initControl(f,a);k.addEventListener("click",function(){d.insertAdjacentElement("afterbegin",f);e.parentNode.removeChild(e);l.controlChange(f,
g,a)},{once:!0,passive:!0});f.addEventListener("focusin",function(){k.click()},{once:!0,passive:!0});g.addEventListener("focusin",function(a){f.dataset.minicolorsInitialized?p(f).minicolors("show"):(f.dataset.opacity=this.value,k.click())},{passive:!0});void 0!==u&&this.setColor(f,m,g,u);c.appendChild(d);void 0!==a.after&&c.appendChild(b.after(a));void 0!==a.description&&c.appendChild(b.description(a.description));void 0!==a.tooltip&&c.appendChild(b.tooltip(a.tooltip));return c}},text:{update(a,b,
c){a=w.document.getElementById(a);null!==a&&(a.value=void 0!==b?b:"")},render(a,b){const c=h.createDocumentFragment(),d=h.createElement("input"),e=b.getStyleVal(a.id);d.type=void 0!==a.input_type?a.input_type:"text";!0===b.is_repeat?(d.className=!0===b.is_sort?"tb_lb_sort_child":"tb_lb_option_child",d.dataset.inputId=a.id):(d.className="tb_lb_option",d.id=a.id);void 0!==a.placeholder&&(d.placeholder=a.placeholder);if(void 0!==a.custom_args)for(let b in a.custom_args)d.setAttribute(b,a.custom_args[b]);
void 0!==e&&(d.value=e);void 0!==a["class"]&&(d.className+=" "+a.class);c.appendChild(b.initControl(d,a));void 0!==a.unit&&c.appendChild(b.select.render(a.unit,b));void 0!==a.after&&c.appendChild(b.after(a));void 0!==a.description&&c.appendChild(b.description(a.description));void 0!==a.tooltip&&c.appendChild(b.tooltip(a.tooltip));return c}},number:{render(a,b){a.input_type="number";void 0===a.custom_args&&(a.custom_args={min:0});void 0!==a.step&&(void 0===a.custom_args&&(a.custom_args={}),a.custom_args.step=
a.step);return b.text.render(a,b)}},angle:{render(a,b){a.input_type="number";a.custom_args={min:0,max:360};const c=h.createElement("div");c.tabIndex=-1;c.className="tb_angle_container tf_rel";a.class=void 0!==a["class"]?a["class"]+" xsmall tb_lb_option tb_angle_input":"xsmall tb_lb_option tb_angle_input";c.appendChild(b.text.render(a,b));const d=c.querySelector("#"+a.id);b.afterRun.push(function(){const a=l.Utils.getMouseEvents();d.addEventListener(a.mousedown,function(b){b.stopImmediatePropagation();
let c=this.parentNode.querySelector(".tb_angle_circle");if(!c){let a=this.value;const b=h.createElement("div"),d=h.createElement("div");c=h.createElement("div");""!==a&&(b.style.transform="rotate("+a+"deg)");b.className="tb_angle_dot";c.className="tb_angle_circle";d.className="tb_angle_circle_wrapper";c.appendChild(b);d.appendChild(c);this.parentNode.appendChild(d)}c.addEventListener(b.type,function(b){if("touchstart"===b.type||1===b.which){var c=this.getBoundingClientRect();let e=this.offsetWidth/
2+c.left,f=this.offsetHeight/2+c.top,g;this.parentNode.querySelector(".tb_angle_circle_wrapper");let k=this.parentNode.querySelector(".tb_angle_dot");const h=180/Math.PI;c=this.ownerDocument;const m=function(a){a.stopImmediatePropagation();this.body.classList.add("tb_start_animate","tb_show_overlay");this.body.style.cursor="grab"},l=function(a){a.stopImmediatePropagation();g&&cancelAnimationFrame(g);g=requestAnimationFrame(function(){let b=Math.atan2(f-(a.touches?a.touches[0].clientY:a.clientY),e-
(a.touches?a.touches[0].clientX:a.clientX))*h;b-=90;0>b&&(b+=360);b=Math.round(b);k.style.transform="rotate("+b+"deg)";d.value=b;x.triggerEvent(d,"change")})};c.addEventListener(a.mousemove,m,{passive:!0,once:!0});c.addEventListener(a.mousemove,l,{passive:!0});c.addEventListener(a.mouseup,function(b){g&&cancelAnimationFrame(g);this.removeEventListener(a.mousemove,m,{passive:!0,once:!0});this.removeEventListener(a.mousemove,l,{passive:!0});this.body.classList.remove("tb_start_animate","tb_show_overlay");
this.body.style.cursor="";requestAnimationFrame(function(){k=e=g=f=null})},{passive:!0,once:!0});l(b)}},{passive:!0})},{passive:!0,once:!0})});return c}},autocomplete:{cache:{},xhr:null,render(a,b){b=b.text.render(a,b);if(void 0===a.dataset)return b;const c=b.querySelector("input"),d=this,e=h.createElement("div");c.autocomplete="off";e.className="tb_autocomplete_container";b.appendChild(e);c.addEventListener("input",function(){const b=this.nextElementSibling;for(b.style.display="none";null!==b.firstChild;)b.removeChild(b.firstChild);
...
{id:a.id+"-circle-radial",options:[{name:"1",value:b.label.circle_radial}]}));c.appendChild(k);c.appendChild(m);c.appendChild(l);b.initControl(m,a);b.afterRun.push(function(){q.controlChange(b,k,m,l,e,t.getElementsByClassName("tb_angle_input")[0],c.getElementsByClassName("tb-checkbox")[0],g)});return c}},fontColor:{update(a,b,c){c.radio.update(a,c.getStyleVal(a),c)},render(a,b){a.isFontColor=!0;const c=b.radioGenerate("radio",{id:a.id,type:"radio",option_js:!0,isFontColor:!0,options:[{value:a.s+"_solid",
name:b.label.solid},{value:a.g+"_gradient",name:b.label.gradient}]}),d=c.querySelector(".tb_lb_option"),e=p.extend(!0,{},a);e.label="";e.type="color";e.id=a.s;e.prop="color";e.wrap_class="tb_group_element_"+a.s+"_solid";const f=b.create([e]);e.id=a.g;e.wrap_class="tb_group_element_"+a.g+"_gradient";e.type="gradient";e.prop="background-image";const g=b.create([e]);b.afterRun.push(function(){const a=d.parentNode.closest(".tb_field");a.parentNode.insertBefore(f,a.nextElementSibling);a.parentNode.insertBefore(g,
a.nextElementSibling)});return c}},imageGradient:{update(a,b,c){c.radio.update(a+"-type",c.getStyleVal(a+"-type"),c);c.file.update(a,b,c);c.gradient.update(a,b,c);a=w.document.getElementById(a);if(null!==a){b=a.closest(".tb_tab");a=b.getElementsByClassName("tb_image_options");b=b.getElementsByClassName("tb_gradient_image_color")[0].getElementsByClassName("minicolors-input")[0].id;c.color.update(b,c.getStyleVal(b),c);for(let d=0;d<a.length;++d)b=a[d].getElementsByClassName("tb_lb_option")[0].id,c.select.update(b,
c.getStyleVal(b),c)}},render(a,b){const c=h.createElement("div"),d=h.createElement("div");c.className="tb_image_gradient_field";d.className="tb_group_element_image";c.appendChild(b.radioGenerate("radio",{type:a.type,id:a.id+"-type",options:[{name:b.label.image,value:"image"},{name:b.label.gradient,value:"gradient"}],option_js:!0}));const e=p.extend(!0,{},a);e.type="image";e.class="xlarge";d.appendChild(b.file.render("image",p.extend(!0,{},e),b));c.appendChild(d);e.type="gradient";delete e.class;delete e.binding;
...
l.hasChanged=!0;x.triggerEvent(this,"change",{val:b.id})}})},update(a,b,c){c=w.document.getElementById(a);if(null!==c){a=c.getElementsByClassName("tfl-icon");for(let c=a.length-1;-1<c;--c)b===a[c].id?a[c].classList.add("selected"):a[c].classList.remove("selected");void 0===b&&(b=c.dataset["default"],b=void 0===b?a[0]:b.querySelector("#"+b),b.classList.add("selected"))}},render(a,b){const c=h.createElement("div");let d=b.getOptions(a);var e=b.getStyleVal(a.id);!0===a.color&&!0===a.transparent&&(d=
d.slice(),d.push({img:"transparent",value:"transparent",label:b.label.transparent}));c.className="themify-layout-icon";!0===b.is_repeat?(c.className+=!0===b.is_sort?" tb_lb_sort_child":" tb_lb_option_child",c.dataset.inputId=a.id):(c.className+=" tb_lb_option",c.id=a.id);void 0!==a["class"]&&(c.className+=" "+a.class);void 0===e&&(e=themifyBuilder.modules[b.type],e=void 0!==e&&void 0!==e.defaults&&e.defaults[a.id]?e.defaults[a.id]:d[0].value);for(let b=0,g=d.length;b<g;++b){let f=h.createElement("a"),
g=h.createElement("span"),l;f.href="#";f.className="tfl-icon";f.id=d[b].value;e===d[b].value.toString()&&(f.className+=" selected");g.className="themify_tooltip";g.textContent=d[b].label;"sprite"===a.mode&&-1===d[b].img.indexOf(".png")?(l=h.createElement("span"),l.className="tb_sprite",-1!==d[b].img.indexOf("http")?l.style.backgroundImage="url("+d[b].img+")":l.className+=" tb_"+d[b].img):(l=h.createElement("img"),l.alt=d[b].label,l.src=-1!==d[b].img.indexOf("http")?d[b].img:themifyBuilder.builder_url+
"/editor/img/"+d[b].img);f.appendChild(l);f.appendChild(g);c.appendChild(f)}this.controlChange(c);"row"!==b.component||"row_width"!==a.id&&"row_height"!==a.id?b.initControl(c,a):l.Utils.changeOptions(c,a.type);return c}},layoutPart:{data:[],get(a){const b=this;p.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_get_library_items",nonce:themifyBuilder.tb_load_nonce,pid:themifyBuilder.post_ID},beforeSend(a){z.showLoader("show")},success(c){z.showLoader("hide");b.data=c;a()},
error(){z.showLoader("error")}})},render(a,b){function c(){const c=b.values[a.id],e=null!==l.Forms.LayoutPart.id?l.Forms.LayoutPart.id.toString():null;m.appendChild(h.createElement("option"));for(let a=0,b=d.data.length;a<b;++a)if(e!==d.data[a].id.toString()){let b=h.createElement("option");b.value=d.data[a].post_name;b.textContent=d.data[a].post_title;c===d.data[a].post_name&&(b.selected=!0);m.appendChild(b)}}const d=this,e=h.createDocumentFragment(),f=b.select.render(a,b),g=h.createElement("a"),
k=h.createElement("a"),m=f.querySelector("select");0===d.data.length?d.get(c):c();e.appendChild(f);g.target=k.target="_blank";g.className="tb_icon_btn";g.href=a.edit_url;k.href=a.add_url;k.className="add_new tf_plus_icon tb_icon_btn";g.appendChild(l.Utils.getIcon("ti-folder"));g.appendChild(h.createTextNode(b.label.mlayout));k.appendChild(h.createTextNode(b.label.nlayout));e.appendChild(h.createElement("br"));e.appendChild(k);e.appendChild(g);return e}},separator:{render(a,b){const c=void 0!==b.label[a.label]?
b.label[a.label]:a.label;if(void 0!==c){b=void 0!==a.wrap_class?h.createElement("div"):h.createDocumentFragment();const d=h.createElement("h4");d.textContent=c;b.appendChild(h.createElement("hr"));b.appendChild(d)}else void 0!==a.html?(b=h.createElement("div"),b.innerHTML=a.html,b=b.firstChild):b=h.createElement("hr");void 0!==a.wrap_class&&(b.className=a.wrap_class);return b}},multiColumns:{render(a,b){const c=[],d=[{id:a.id+"_gap",label:b.label.c_g,type:"range",prop:"column-gap",selector:a.selector,
...
d[a]&&delete d[a];delete d._orderByField;a=new w.wp.shortcode({tag:"gallery",attrs:d,type:"single"});wp.media.gallery.shortcode=c;return a};a=b.value.trim();0<a.length?(d.file_frame=wp.media.gallery.edit(a),d.file_frame.state("gallery-edit")):(d.file_frame.state("gallery-library"),d.file_frame.open(),d.file_frame.$el.find(".media-menu .media-menu-item").last().trigger("click"));a=function(a){const c=wp.media.gallery.shortcode(a).string().slice(1,-1);b.value="["+c+"]";f(a.models);x.triggerEvent(b,
"change");l.hasChanged=!0};d.file_frame.off("update",a).on("update",a)})},render(a,b){const c=h.createDocumentFragment(),d=h.createElement("a"),e=this;let f=void 0!==a.class?a.class:"";d.href="#";d.className="builder_button tb_gallery_btn";d.textContent=b.label.add_gallery;a.class=f+" tb_shortcode_input";c.appendChild(b.textarea.render(a,b));c.appendChild(d);b.afterRun.push(function(){e.init(d,d.previousElementSibling);!0===b.is_new&&"gallery"===b.type&&"setting"===b.clicked&&d.click()});return c}},
textarea:{render(a,b){const c=h.createDocumentFragment(),d=h.createElement("textarea"),e=b.getStyleVal(a.id);!0===b.is_repeat?(d.className=!0===b.is_sort?"tb_lb_sort_child":"tb_lb_option_child",d.dataset.inputId=a.id):(d.className="tb_lb_option",d.id=a.id);d.className+=" "+(void 0!==a["class"]?a.class:"xlarge");void 0!==e&&(d.value=e);void 0!==a.rows&&(d.rows=a.rows);c.appendChild(b.initControl(d,a));void 0!==a.after&&c.appendChild(b.after(a));void 0!==a.description&&c.appendChild(b.description(a.description));
return c}},address:{render(a,b){return b.textarea.render(a,b)}},wp_editor:{render(a,b){const c=h.createElement("div"),d=h.createElement("div"),e=h.createElement("div"),f=h.createElement("button"),g=h.createElement("span"),k=h.createElement("div"),m=h.createElement("button"),l=h.createElement("button"),q=h.createElement("div"),n=h.createElement("div"),t=h.createElement("textarea");let r;c.className="wp-core-ui wp-editor-wrap tmce-active";t.className="tb_lb_wp_editor fullwidth";!0===b.is_repeat?(r=
Math.random().toString(36).substr(2,7),t.className+=!0===b.is_sort?" tb_lb_sort_child":" tb_lb_option_child",t.dataset.inputId=a.id,!1!==a.control&&(void 0===a.control&&(a.control={}),a.control.repeat=!0)):(t.className+=" tb_lb_option",r=a.id);t.id=r;c.id="wp-"+r+"-wrap";d.id="wp-"+r+"-editor-tools";d.className="wp-editor-tools";e.id="wp-"+r+"-media-buttons";e.className="wp-media-buttons";f.type="button";f.className="button insert-media add_media";g.className="wp-media-buttons-icon";k.className="wp-editor-tabs";
m.type="button";m.className="wp-switch-editor switch-tmce";m.id=r+"-tmce";m.dataset.wpEditorId=r;m.textContent=b.label.visual;l.type="button";l.className="wp-switch-editor switch-html";l.id=r+"-html";l.dataset.wpEditorId=r;l.textContent=b.label.text;q.id="wp-"+r+"-editor-container";q.className="wp-editor-container";n.id="qt_"+r+"_toolbar";n.className="quicktags-toolbar";void 0!==a["class"]&&(t.className+=" "+a.class);void 0!==b.values[a.id]&&(t.value=b.values[a.id]);t.rows=12;t.cols=40;q.appendChild(t);
q.appendChild(n);k.appendChild(m);k.appendChild(l);f.appendChild(g);f.appendChild(h.createTextNode(b.label.add_media));e.appendChild(f);d.appendChild(e);d.appendChild(k);c.appendChild(d);c.appendChild(q);b.editors.push({el:t,data:a});return c}},select:{dataset_cache:{},update(a,b,c){a=w.document.getElementById(a);null!==a&&(void 0!==b?a.value=b:void 0!==a[0]&&(a[0].selected=!0))},make_options:function(a,b,c){const d=h.createDocumentFragment();c=c.getOptions(a);for(let e in c){let f=h.createElement("option");
f.value=e;f.text=c[e];void 0!==a.binding&&void 0!==a.binding[e]&&void 0!==a.binding[e].responsive&&void 0!==a.binding[e].responsive.disabled&&-1!==a.binding[e].responsive.disabled.indexOf(a.id)&&(f.className="responsive_disable");if(b===e||void 0===b&&e===a.default)f.selected=!0;d.appendChild(f)}return d},render(a,b){const c=this,d=h.createElement("div"),e=h.createElement("select"),f=h.createDocumentFragment(),g=b.getStyleVal(a.id);d.className="selectwrapper";!0===b.is_repeat?(e.className=!0===b.is_sort?
"tb_lb_sort_child":"tb_lb_option_child",e.dataset.inputId=a.id):(e.className="tb_lb_option",e.id=a.id);void 0!==a["class"]&&(e.className+=" "+a.class);const k=function(a){if(a.optgroup){a=b.getOptions(a);for(let d in a)if(void 0!==a[d].label){let f=h.createElement("optgroup");f.setAttribute("label",a[d].label);f.appendChild(c.make_options(a[d],g,b));e.appendChild(f)}else e.appendChild(c.make_options(a[d],g,b))}else e.appendChild(c.make_options(a,g,b))};void 0!==a.dataset?void 0!==c.dataset_cache[a.dataset]?
k(c.dataset_cache[a.dataset]):p.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_get_select_dataset",dataset:a.dataset,nonce:themifyBuilder.tb_load_nonce,pid:themifyBuilder.post_ID},beforeSend(a){z.showLoader("show")},success(b){b.success&&(z.showLoader("hide"),c.dataset_cache[a.dataset]=b.data,k(b.data))},error(){z.showLoader("error")}}):k(a);d.appendChild(b.initControl(e,a));f.appendChild(d);void 0!==a.after&&f.appendChild(b.after(a));void 0!==a.description&&f.appendChild(b.description(a.description));
...
a.clientY),m=c.w,l=c.h,n=function(a){d=!0;f.body.classList.add("tb_start_animate","tb_move_drag")},u=function(a){a.stopImmediatePropagation();b&&cancelAnimationFrame(b);b=requestAnimationFrame(function(){let b=h+(a.touches?a.touches[0].clientX:a.clientX),d=k+(a.touches?a.touches[0].clientY:a.clientY);b>m?b=m:0>b&&(b=0);d>l?d=l:0>d&&(d=0);g.style.left=b+"px";g.style.top=d+"px";c.changeUpdate(g,b,d)})};f.addEventListener(e.mouseup,function(a){this.removeEventListener(e.mousemove,n,{passive:!0,once:!0});
this.removeEventListener(e.mousemove,u,{passive:!0});d&&(a.stopImmediatePropagation(),b&&cancelAnimationFrame(b),b=d=null,this.body.classList.remove("tb_start_animate","tb_move_drag"))},{passive:!0,once:!0});f.addEventListener(e.mousemove,n,{passive:!0,once:!0});f.addEventListener(e.mousemove,u,{passive:!0})}},{passive:!0});m.addEventListener("click",this.click.bind(this));k.appendChild(u);k.appendChild(m);g.appendChild(k);void 0!==a.after&&g.appendChild(b.after(a));g.appendChild(q);g.appendChild(n);
b.afterRun.push(function(){setTimeout(function(){const d=window.getComputedStyle(m);c.w=parseInt(d.getPropertyValue("width"));c.h=parseInt(d.getPropertyValue("height"));c.update(a.id,f,b)},700)});return g}},slider_range:{render:function(a,b){const c=h.createElement("div"),d=h.createElement("div"),e=b.hidden.render(a,b);let f=0,g=100,k="%",m=!0,l=1;void 0!==a.options&&(void 0!==a.options.min&&(f=a.options.min),void 0!==a.options.max&&(g=a.options.max),void 0!==a.options.unit&&(k=a.options.unit),void 0!==
a.options.range&&(m=!1),void 0!==a.options["default"]&&(l=a.options["default"]));e.setAttribute("data-min",f);e.setAttribute("data-max",g);e.setAttribute("data-unit",k);c.className="tb_slider_wrapper input-range";d.className="range-slider";void 0!==a.wrap_class&&(c.className=" "+a.wrap_class);c.appendChild(d);c.appendChild(e);const q=function(a){const b=h.createElement("span"),c=h.createElement("span");var d=parseFloat(e.getAttribute("data-min"));const f=parseFloat(e.getAttribute("data-max")),g=e.getAttribute("data-unit");
let k=e.value;k=m?k?k.split(","):[d,f]:k?k:l;b.className="tb_slider_label_l";c.className="tb_slider_label_u";d={range:m,min:d,max:f,slide:function(a,d){m?(b.textContent=d.values[0]+g,c.textContent=d.values[1]+g):b.textContent=d.value+g},create(a,d){a=this.getElementsByClassName("ui-slider-handle");m?(b.textContent=k[0]+g,a[0].appendChild(b),c.textContent=k[1]+g,a[1].appendChild(c)):(b.textContent=k+g,a[0].appendChild(b));k=null},change:function(a,b){e.value=m?b.values[0]+","+b.values[1]:b.value}};
m?d.values=k:d.value=k;w.jQuery.fn.slider.call(p(a),d)};b.afterRun.push(function(){w.Themify.LoadAsync(themifyBuilder.includes_url+"js/jquery/ui/slider.min.js",function(){q(d)},themify_vars.version,null,function(){return void 0!==w.jQuery.fn.slider})});return c}},range:{update(a,b,c){const d=z.Lightbox.$lightbox[0].querySelector("#"+a);null!==d&&(d.value=void 0!==b?b:"",b=a+"_unit",a=w.document.getElementById(b),null!==a&&"SELECT"===a.tagName&&(c=c.getStyleVal(b),void 0===c&&(c=a[0].value),a.value=
...
h.createElement("div");var g=Object.keys(a.units);d.className="selectwrapper noborder";if(1<g.length){f=b.getStyleVal(a.id+"_unit");const c=a.id+"_unit";g=h.createElement("select");g.className="tb_unit";!0===b.is_repeat?(g.className+=!0===b.is_sort?" tb_lb_sort_child":" tb_lb_option_child",g.dataset.inputId=c):(g.className+=" tb_lb_option",g.id=c);void 0!==a.select_class&&(g.className+=" "+a.select_class);for(var k in a.units){let b=h.createElement("option");a.units[k]||(a.units[k]={});a.units[k].min||
(a.units[k].min=0);a.units[k].max||(a.units[k].max=100);e.setAttribute("min",parseInt(a.units[k].min));e.setAttribute("max",parseInt(a.units[k].max));b.value=k;b.textContent=k;b.dataset.min=a.units[k].min;b.dataset.max=a.units[k].max;b.dataset.increment=void 0!==a.units[k].increment?a.units[k].increment:"em"===k||"em"===k?.1:1;f===k&&(b.selected=!0);g.appendChild(b)}b.initControl(g,{type:"select",id:c,control:a.control})}else k=g[0],a.units[k]||(a.units[k]={}),a.units[k].min||(a.units[k].min=0),a.units[k].max||
(a.units[k].max=100),e.setAttribute("min",parseFloat(a.units[k].min)),e.setAttribute("max",parseFloat(a.units[k].max)),e.setAttribute("step",void 0!==a.units[k].increment?parseFloat(a.units[k].increment):"1"),f<parseFloat(a.units[k].min)?e.value=a.units[k].min:f>parseFloat(a.units[k].max)&&(e.value=a.units[k].max),g=h.createElement("span"),g.className="tb_unit",g.id=a.id+"_unit",g.dataset.min=a.units[k].min,g.dataset.max=a.units[k].max,g.dataset.increment=void 0!==a.units[k].increment?a.units[k].increment:
"em"===k||"em"===k?.1:1,g.textContent=k;d.appendChild(g);c.appendChild(d)}void 0!==a.after&&c.appendChild(b.after(a.after));void 0!==a.description&&c.appendChild(b.description(a.description));d="styling"===b.clicked?"keyup":"change";!0===a.opposite&&g.addEventListener("change",function(a){a.stopPropagation();b.margin.changeUnit(this)},{passive:!0});this.controlChange(e,g,d);g=p.extend({},a);!0===a.opposite&&e.addEventListener(d,function(a){a.stopPropagation();b.margin.changeOppositive(this)},{passive:!0});
g.type="range";b.initControl(e,g);return c}},icon:{render(a,b){const c=h.createElement("div"),d=h.createElement("input"),e=h.createElement("span"),f=h.createElement("span"),g=b.getStyleVal(a.id);d.type="text";d.className="themify_field_icon";e.className="tf_plus_icon themify_fa_toggle";c.className="tb_icon_wrap";f.className="tb_clear_input tf_close";!0===b.is_repeat?(d.className+=!0===b.is_sort?" tb_lb_sort_child":" tb_lb_option_child",d.dataset.inputId=a.id):(d.className+=" tb_lb_option",d.id=a.id);
...
d=h.createElement("ul"),e=a.id,f=p.extend(!0,{},a);f["class"]="tb_filters_field";f.prop=null;d.className="tb_seperate_items tb_filters_fields";for(let g in c)if(void 0!==c[g]){let k=c[g],l=h.createElement("li"),p=h.createElement("div"),q=h.createElement("span"),n=e+"_"+g;f.id=n;f.units=k.units;f.selector=a.selector;p.className="tb_label";q.className="tb_label_text";q.textContent=k.label;p.appendChild(q);l.appendChild(p);l.appendChild(b.range.render(f,b));d.appendChild(l);b.styles[n]={prop:k.prop,
selector:a.selector}}return d}},help(a){const b=h.createElement("div"),c=h.createElement("div"),d=h.createElement("i");b.className="tb_help";c.className="tb_help_content";d.tabIndex=-1;d.className="icon";c.innerHTML=a;d.appendChild(tb_app.Utils.getIcon("ti-help"));b.appendChild(d);b.appendChild(c);return b},tooltip(a){const b=h.createElement("span");b.className="tb_tooltip_up";b.textContent=a;return b},description(a){const b=h.createElement("small");b.innerHTML=a;return b},after(a){const b=h.createElement("span");
...
max:100},em:{min:0,max:100}},a,b,b.label.tl));d.appendChild(this._rotate(a,b));d.appendChild(this._xy("skew",{deg:{min:-180,max:180}},a,b,b.label.sk));c.appendChild(d);return c}}}})(jQuery,Themify,window.top,document);
